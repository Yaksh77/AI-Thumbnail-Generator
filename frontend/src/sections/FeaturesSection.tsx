  ...
  return (
    <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
      <SectionTitle
        ...
        text3="Create high-quality UI thumbnails from your imagination"
      />
        ...
        {featuresData.map((feature: IFeature, index: number) => (
          ...
          >
            <div className="p-6 rounded-xl space-y-4 border border-slate-800 bg-slate-950 max-w-80 w-full">
              {<feature.icon className="size-6 text-pink-500" />}
      ...
      <div className="mt-40 relative mx-auto max-w-5xl">
        ...
        >
          Our thumbnail generator is a powerful tool that allows you to create
          high-quality UI thumbnails from your imagination.
        </motion.p>
        <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
          ...
          >
            ...
            <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">
              Create stunning UI thumbnails{" "}
            </h3>
            <p className="text-slate-300 mt-2">
              Our thumbnail generator is a powerful tool that allows you to
              create high-quality UI thumbnails from your imagination.
            </p>
            <a
