...
import type { AspectRatio, IThumbnail } from "../assets/assets/assets";
      ...
      <div className={`relative overflow-hidden ${aspectClasses[aspectRatio]}`}>
        ...
        {isLoading && (
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-black/25">
            <Loader2Icon className="sizw-8 animate-spin text-zinc-400" />
          ...
          <div className="group relative h-full w-full">
            ...
            <div className="absolute inset-0 flex items-end justify-center bg-black/10 opacity-0 transition-opacity group-hover:opacity-100">
              <button
                onClick={onDownload}
                type="button"
                className="mb-6 flex items-center gap-2 rounded-md px-5 py-2.5 text-xs font-medium transition bg-white/30 ring-2 ring-white/40 backdrop-blur-2xl hover:scale-105 active:scale-95"
              >
