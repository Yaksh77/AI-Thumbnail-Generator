...
import { thumbnailStyles, type ThumbnailStyle } from "../assets/assets/assets";
import {
  CpuIcon,
  ImageIcon,
  PenToolIcon,
...
const StyleSelector = ({
  ...
  const styleIcons: Record<ThumbnailStyle, React.ReactNode> = {
    "Bold & Graphic": <Sparkles className="size-4" />,
    Minimalist: <Square className="size-4" />,
